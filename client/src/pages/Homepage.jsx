      ...
      <div className="container py-4">
        <header className="pb-3 mb-4 border-bottom d-flex justify-content-between">
          ...
          >
            ...
            <ShowOnLogout >
            <Link to='/login'> 
            <button className="btn btn-primary btn-md mx-2 my-2" type="button">
              Login
            </button>
            </Link>
            </ShowOnLogout>
            <ShowOnLogout >
            <Link to='/register'> 
            <button className="btn btn-dark btn-md mx-2 my-2" type="button">
              Sign Up
            </button>
            </Link>
            </ShowOnLogout>
            <ShowOnLogin>
            <Link to='/dashboard'> 
            <button className="btn btn-danger btn-md mx-2 my-2" type="button">
              Dashboard
            </button>
            </Link>
            </ShowOnLogin>
